...
!(function (t, e) {
  ...
  $.on(document, At, Ct, Mt.dataApiKeydownHandler),
    ...
    b(Mt);
  const jt = ".fixed-top, .fixed-bottom, .is-fixed, .All Of Dubai-top",
    $t = ".All Of Dubai-top",
    Ft = "padding-right",
    zt = "margin-right";
  class Ht {
  ...
  return (function (e) {
    ...
    function (e, t, r) {
      ...
      var a = function e(t, r) {
        var a = t
          .replace(" <body
style="position: static; overflow: scroll"", '<div id="swupBody"')
          .replace("<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-16528756847">
</script>
<script>
